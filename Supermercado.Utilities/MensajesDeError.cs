...
namespace SuperMercado.Utilidades
{
   ...
   public class MensajesDeError : IdentityErrorDescriber
    {
        ...
        public override IdentityError DuplicateUserName(string userName) { return new IdentityError { Code = nameof(DuplicateUserName), Description = $"'{userName}' ya existe, Por favor Inicie Sesión" }; }
