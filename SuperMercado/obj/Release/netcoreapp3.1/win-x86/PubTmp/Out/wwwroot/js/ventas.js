...
function load(Cat = false) {
    ...
    <div class=" d-sm-block d-lg-block col-md-3 text-center ">
     ...
     <div class=" d-sm-block d-lg-block col-md-3 text-center ">
							${ventaEstado ? `` : ventaEstado==false?``: `<a onclick="Aprobar(${ventaID})" class="btn btn-success mr-1"><i class="fas fa-check"></i></a><a  onclick="Denegar(${ventaID})" class="btn btn-danger"><i class="fas fa-times text-trash "></i></a>`}
    </div>
